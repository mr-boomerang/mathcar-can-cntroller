...
int main(int argc, char **argv)
{
  ...
  double speed = 0, steer = 15 * M_PI / 180, speed_max = 5.0;
  ...
  while (n.ok())
  {
    ...
    {
      speed = speed_max * sin(timer_counter * M_PI / timer_total);
    }
    ...
    {
      speed = speed_max / 2 / M_PI / timer_total *
              (2 * M_PI * timer_counter -
               (timer_total)*sin(2 * timer_counter * M_PI / timer_total));
    }
