 ...
 **/
#ifndef INTERFACES_PERIPHERALS_REDGEAR_H
#define INTERFACES_PERIPHERALS_REDGEAR_H
...
/// @brief Actions for redgear joystick
class Redgear : public ControllerBase
{
 private:
 public:
  /// constructor
...
#endif  // INTERFACES_PERIPHERALS_REDGEAR_H
