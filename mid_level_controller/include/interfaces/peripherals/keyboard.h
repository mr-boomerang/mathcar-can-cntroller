 ...
 **/
#ifndef INTERFACES_PERIPHERALS_KEYBOARD_H
#define INTERFACES_PERIPHERALS_KEYBOARD_H
...
class Keyboard : public ControllerBase
{
 ...
 public:
   ...
   */
  void ProcessMessage(char key_in);
  /**
...
#endif  // INTERFACES_PERIPHERALS_KEYBOARD_H
