...
sleep 5
rosrun mid_level_controller teleop_car --cfg $settings_file_name --mode keyboard

# rosrun mid_level_controller teleop_car --cfg settings_default.cfg --mode keyboard
# rosrun mid_level_controller teleop_car --cfg settings_default.cfg --mode joy --joy_path /dev/input/js0
